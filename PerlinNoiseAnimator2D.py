...
def transform_coord(i, j, z, at_z):
    return i /scale - at_z, j/scale - at_z - z
...
for t in np.arange(0, ani_len):
    ...
    frames.append((plt.pcolor(x, y, base, shading='auto',cmap='Greys', vmin = -1, vmax = 1),))

im_ani = animation.ArtistAnimation(fig2, frames, interval=30, repeat = True,
                                   blit=False)
